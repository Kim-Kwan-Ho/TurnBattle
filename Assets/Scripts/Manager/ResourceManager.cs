...
public class ResourceManager
{
    ...
    {
        return File.ReadAllText($"Assets/Resources/Data/{name}.json");
    }
    public T GetObjectByJson<T>(string name) where T : struct
    {
        return JsonUtility.FromJson<T>(ReadAllText(name));
    }
